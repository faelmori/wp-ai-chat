    ...
    <form method="post" action="options.php">
      ...
      <table class="form-table">
        <tr valign="top">
          ...
          <td>
            <input type="text" name="docmee_api_key" value="<?php echo esc_attr(get_option('docmee_api_key')); ?>"
              style="width:400px;" />
          </td>
        </tr>
        <tr valign="top">
          ...
          <td>
            <input type="number" name="docmee_token_limit"
              value="<?php echo esc_attr(get_option('docmee_token_limit', 10)); ?>" min="1" max="100" />
          </td>
        </tr>
        <tr valign="top">
          ...
          <td>
            <input type="text" name="docmee_container_width"
              value="<?php echo esc_attr(get_option('docmee_container_width', '80%')); ?>" style="width:100px;" />
        ...
        <tr valign="top">
          ...
          <td>
            <input type="number" name="docmee_ppt_height"
              value="<?php echo esc_attr(get_option('docmee_ppt_height', 800)); ?>" min="100" />
        ...
        <tr valign="top">
          ...
          <td>
            <input type="checkbox" name="docmee_vip_check_enabled" value="1" <?php checked(1, get_option('docmee_vip_check_enabled'), true); ?> />
        ...
        <tr valign="top">
          ...
          <td>
            <input type="text" name="docmee_vip_keyword"
              value="<?php echo esc_attr(get_option('docmee_vip_keyword', '升级VIP享受精彩下载')); ?>" style="width:400px;" />
        ...
        <tr valign="top">
          ...
          <td>
            <input type="text" name="docmee_vip_prompt_page"
              value="<?php echo esc_attr(get_option('docmee_vip_prompt_page')); ?>" style="width:400px;" />
...
function docmee_ppt_shortcode()
{
  ...
  ?>
    <div id="vip-prompt-overlay"
      ...
      <div id="vip-prompt"
        style="position:fixed;top:50%;left:50%;transform:translate(-50%,-50%);background:#fff;padding:30px 40px;border-radius:12px;box-shadow:0 8px 30px rgba(0,0,0,0.2);text-align:center;z-index:99999;min-width:380px;">
        ...
        <div style="display:flex;gap:15px;justify-content:center;">
          <button onclick="handleLoginAction('confirm')"
            style="padding:12px 30px;background:#0073aa;color:#fff;border:none;border-radius:25px;cursor:pointer;font-size:16px;transition:all 0.3s;flex:1;">
            ⚡ 立即登录
          </button>
        </div>
      </div>
  ...
  <div class="docmee-container-wrapper" style="width: <?php echo esc_attr($container_width); ?>;">
    ...
    <div id="message-box"
      style="display:none; padding: 10px; margin-top: 20px; background-color: #f57bb0; color: white; border-radius: 5px; text-align: center;">
    </div>
