    ...
    <form method="post" action="options.php">
      ...
      <table class="form-table">
        ...
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[deepseek_api_key]"
              value="<?php echo isset($options['deepseek_api_key']) ? esc_attr($options['deepseek_api_key']) : ''; ?>"
              size="50" />
          </td>
        </tr>
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[deepseek_model]"
              value="<?php echo isset($options['deepseek_model']) ? esc_attr($options['deepseek_model']) : 'deepseek-chat'; ?>"
              size="50" />
          </td>
        </tr>
        <!-- 通义千问 设置 -->
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[tongyi_api_key]"
              value="<?php echo isset($options['tongyi_api_key']) ? esc_attr($options['tongyi_api_key']) : ''; ?>"
              size="50" />
          </td>
        </tr>
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[tongyi_model]"
              value="<?php echo isset($options['tongyi_model']) ? esc_attr($options['tongyi_model']) : 'qwen-plus'; ?>"
              size="50" />
          </td>
        </tr>
        <!-- 豆包AI 设置 -->
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[doubao_api_key]"
              value="<?php echo isset($options['doubao_api_key']) ? esc_attr($options['doubao_api_key']) : ''; ?>"
              size="50" />
          </td>
        </tr>
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[doubao_model]"
              value="<?php echo isset($options['doubao_model']) ? esc_attr($options['doubao_model']) : ''; ?>"
              size="50" />
          </td>
        </tr>
        <!-- 翻译语言设置 -->
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[translation_languages]"
              value="<?php echo isset($options['translation_languages']) ? esc_attr($options['translation_languages']) : '中文,英文,韩语,日语'; ?>"
              size="50" />
        ...
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[tencent_secret_id]"
              value="<?php echo isset($options['tencent_secret_id']) ? esc_attr($options['tencent_secret_id']) : ''; ?>"
              size="50" />
          </td>
        </tr>
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[tencent_secret_key]"
              value="<?php echo isset($options['tencent_secret_key']) ? esc_attr($options['tencent_secret_key']) : ''; ?>"
              size="50" />
          </td>
        </tr>
        <!-- 腾讯云音库值 -->
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[tencent_voice_type]"
              value="<?php echo isset($options['tencent_voice_type']) ? esc_attr($options['tencent_voice_type']) : '0'; ?>"
              size="10" />
        ...
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[baidu_api_key]"
              value="<?php echo isset($options['baidu_api_key']) ? esc_attr($options['baidu_api_key']) : ''; ?>"
              size="50" />
          </td>
        </tr>
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[baidu_secret_key]"
              value="<?php echo isset($options['baidu_secret_key']) ? esc_attr($options['baidu_secret_key']) : ''; ?>"
              size="50" />
          </td>
        </tr>
        <!-- 百度云音库值 -->
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[baidu_per]"
              value="<?php echo isset($options['baidu_per']) ? esc_attr($options['baidu_per']) : '0'; ?>" size="10" />
        ...
        <tr valign="top">
          ...
          <td>
            <input type="text" name="wpatai_settings[exclude_post_ids]"
              value="<?php echo isset($options['exclude_post_ids']) ? esc_attr($options['exclude_post_ids']) : ''; ?>"
              size="50" />
